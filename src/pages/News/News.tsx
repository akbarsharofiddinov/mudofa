...
// Removed logo-related imports as logo is now handled by NavigationLogo component

// Images
import sport1 from "@/assets/sportsmen/sport-1.jpg"
import sport2 from "@/assets/sportsmen/sport-2.jpg"
import sport3 from "@/assets/sportsmen/sport-3.jpg"
import sport4 from "@/assets/sportsmen/sport-4.jpg"
import sport5 from "@/assets/sportsmen/sport-5.jpg"
import sport6 from "@/assets/sportsmen/sport-6.jpg"
...
const DEFAULT_IMAGES: ImageItem[] = [
  ...
  },
  {
    src: sport5,
    alt: 'karomat omonova',
    desc: "<p>Karomat Omonova (2005-yil 28-aprelda tugʻilgan) — oʻzbek para-yengil atletikachi. U F46 klassida nayza uloqtirish va yadro uloqtirish kabi turlar bilan shugʻullanadi. 2025-yilning oktyabrida Hindiston, Nyu-Deli shahrida oʻtkazilgan Para Jahon atletika chempionatida ayollar F46 toifasida yadro uloqtirish bahslarida 13.07 metr natija bilan Osiyo rekordini yangilab, jahon chempioniga aylandi.</p>"
  },
  {
    src: sport6,
    alt: 'nurxon qurbonova',
    desc: "<p>Nurxon Qurbonova (1994-yil 12-avgustda, Namangan viloyati, Mingbuloq tumanida tugʻilgan) — oʻzbek para-yengil atletikachisi. U F54 klassida nayza uloqtirish, yadro uloqtirish va disk uloqtirish kabi turlarda ishtirok etadi. 2020-yilgi Tokio Paralimpiya oʻyinlarida Qurbonova kumush va bronza medallarini qoʻlga kiritdi. Shuningdek, u 2024-yil Parijda F54 klassida nayza uloqtirish bo‘yicha 21,12 metr natija bilan jahon rekordini yangilab, oltin medalni qo‘lga kiritdi. Qurbonova, shuningdek, jahon chempionatlarida ham oltin medal sohibi boʻlgan.</p>"
  }
];
...
const News: React.FC = ({
  ...
  const openItemFromElement = (el: HTMLElement) => {
    ...
    overlay.style.cssText = `position:absolute; left:${frameR.left - mainR.left}px; top:${frameR.top - mainR.top}px; width:${frameR.width}px; height:${frameR.height}px; opacity:0; z-index:30; will-change:transform,opacity; transform-origin:top left; transition:transform ${enlargeTransitionMs}ms ease, opacity ${enlargeTransitionMs}ms ease; border-radius:${openedImageBorderRadius}; overflow:hidden; box-shadow:0 10px 30px rgba(0,0,0,.35); min-width:800px; min-height:500px;`;
  ...
  return (
    <>
      {/* Logo moved to NavigationLogo component */}
