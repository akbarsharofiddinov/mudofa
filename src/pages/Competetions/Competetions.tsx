...
import competition1 from "@/assets/competitions/competition-1.jpeg";
import competition2 from "@/assets/competitions/competition-2.jpg";
import competition3 from "@/assets/competitions/competition-3.avif";
import competition4 from "@/assets/competitions/competition-4.jpg";
import competition5 from "@/assets/competitions/competition-5.jpg";
import competition6 from "@/assets/competitions/competition-6.jpg";
import competition7 from "@/assets/competitions/competition-7.jpg";
...
const getSportIcon = (sport: string) => {
  ...
  if (
    sportLower.includes("O'q otish") ||
    sportLower.includes("shooting") ||
    sportLower.includes("rifle") ||
    sportLower.includes("vintovka") ||
    sportLower.includes("trap") ||
    sportLower.includes("skeet") ||
    sportLower.includes("pnevmatik")
  ) {
    return { icon: Crosshair, color: "text-red-500" };
  }
  if (
    sportLower.includes("kurash") ||
    sportLower.includes("wrestling") ||
    sportLower.includes("борьба") ||
    sportLower.includes("greco")
  ) {
    return { icon: Users, color: "text-purple-500" };
  }
  if (
    sportLower.includes("boks") ||
    sportLower.includes("boxing") ||
    sportLower.includes("бокс")
  ) {
  ...
  if (
    sportLower.includes("suv") ||
    sportLower.includes("water") ||
    sportLower.includes("polo") ||
    sportLower.includes("suzish") ||
    sportLower.includes("swimming")
  ) {
    return { icon: Waves, color: "text-cyan-500" };
  }
  if (
    sportLower.includes("harbiy") ||
    sportLower.includes("military") ||
    sportLower.includes("pentathlon") ||
    sportLower.includes("yamalaq")
  ) {
    return { icon: Target, color: "text-green-500" };
  }
  if (
    sportLower.includes("aralash") ||
    sportLower.includes("mma") ||
    sportLower.includes("mixed")
  ) {
  ...
  if (
    sportLower.includes("yugurish") ||
    sportLower.includes("running") ||
    sportLower.includes("бег") ||
    sportLower.includes("athletics")
  ) {
    return { icon: Footprints, color: "text-blue-500" };
  }
  if (
    sportLower.includes("velosiped") ||
    sportLower.includes("cycling") ||
    sportLower.includes("велоспорт")
  ) {
    return { icon: Bike, color: "text-emerald-500" };
  }
  if (
    sportLower.includes("yengil") ||
    sportLower.includes("weightlifting") ||
    sportLower.includes("тяжелая")
  ) {
    return { icon: Dumbbell, color: "text-slate-500" };
  }
  if (
    sportLower.includes("harbiy") ||
    sportLower.includes("naval") ||
    sportLower.includes("dengiz")
  ) {
...
const Competetions: React.FC = () => {
  ...
  const competitions: Competition[] = [
    // 2025 Competitions
    {
      ...
      type: "international",
      year: 2025,
      name: "O'zbekiston O'q otish musobaqasi",
      sport: "O'q otish",
      location: "Toshkent, O'zbekiston",
      participants: 520,
      medals: { gold: 4, silver: 5, bronze: 3 },
      date: "23-28 Iyun 2025",
      images: [competition1, competition2],
      videos: ["https://www.youtube.com/embed/fjBZiczqQNA?si=wCOWZoZiLZg-rm4B"],
      participantsList: [
        {
          name: "Doniyor Islamov",
          category: "50m Vintovka",
          result: "Oltin medal - 633.2",
        },
        {
          name: "Mirjalol Khasanov",
          category: "Trap",
          result: "Oltin medal - 49/50",
        },
        {
          name: "Sevara Nematova",
          category: "10m Pnevmatik",
          result: "Kumush medal - 252.7",
        },
        {
          name: "Bekzod Rahimov",
          category: "Vintovka 3x40",
          result: "Bronza medal - 625.8",
        },
      ],
      results:
        "Jami 12 ta medal: 4 oltin, 5 kumush, 3 bronza. O'zbekiston jamoasi umumiy hisobda 3-o'rinni egalladi.",
      description:
        "O'zbekiston poytaxti Toshkentda o'tkazilgan xalqaro o'q otish musobaqasida mamlakatimiz sportchilari ajoyib natijalar ko'rsatdi.",
    },
    {
      id: 102,
      type: "international",
      year: 2025,
      name: "Osiyo Kubogi - O'q otish",
      sport: "Barcha turlar",
      location: "Doha, Qatar",
      participants: 380,
      ...
      images: [competition3],
      videos: ["https://www.youtube.com/embed/CV4z0ixa4rE?si=B-N0wM4rf9_fQjwz"],
      participantsList: [
        {
          name: "Yulduz Tursunova",
          category: "Skeet",
          result: "Oltin medal - 47/50",
        },
        {
          name: "Jasur Aliyev",
          category: "Trap",
          result: "Oltin medal - 48/50",
        },
        {
          name: "Dilnoza Karimova",
          category: "Pnevmatik",
          result: "Kumush medal - 249.8",
        },
      ],
      results:
        "Jami 15 ta medal: 6 oltin, 4 kumush, 5 bronza. O'zbekiston jamoasi 1-o'rinni egalladi.",
      description:
        "Qatarning Doha shahrida bo'lib o'tgan Osiyo kubogida O'zbekiston sportchilari ajoyib natijalar ko'rsatdi.",
    },
    {
      id: 103,
      type: "republican",
      ...
      date: "15-22 May 2025",
      images: [
        competition4, competition5
      ],
      videos: [],
      participantsList: [
        {
          name: "Sardor Yusupov",
          category: "Pnevmatik vintovka",
          result: "Chempion - 635.4",
        },
        {
          name: "Nodira Rahimova",
          category: "Pnevmatik pistolet",
          result: "Chempion - 585.9",
        },
        {
          name: "Aziz Tursunov",
          category: "Vintovka yotgan",
          result: "Chempion - 628.1",
        },
      ],
      results:
        "Respublika bo'ylab 250 ta sportchi ishtirok etdi. Ko'plab yangi rekordlar o'rnatildi.",
      description:
        "Milliy jamoaga a'zolarni tanlash uchun eng muhim musobaqa. 2026-yil xalqaro turnirlariga tayyorgarlik.",
    },
    {
      id: 104,
      type: "republican",
      ...
      images: [
        competition6, competition7
      ],
      videos: [],
      participantsList: [
        {
          name: "Shohruh Karimov (U21)",
          category: "Pnevmatik",
          result: "Oltin - 631.8",
        },
        {
          name: "Malika Azimova (U19)",
          category: "Vintovka",
          result: "Oltin - 618.5",
        },
      ],
      ...
      description:
        "Yoshlar o'rtasida o'tkazilgan eng yirik musobaqa. Milliy jamoa uchun talantlar zaxirasi.",
    },
    // 2024 Competitions
    {
      id: 1,
      type: "international",
      year: 2024,
      name: "ISSF Jahon Kubogi - O'q otish",
      ...
      participantsList: [
        {
          name: "Doniyor Islamov",
          category: "50m Vintovka",
          result: "Oltin medal - 628.5",
        },
        {
          name: "Sevara Nematova",
          category: "10m Pnevmatik",
          result: "Kumush medal - 251.8",
        },
        {
          name: "Bekzod Rahimov",
          category: "50m Yotgan",
          result: "Bronza medal - 463.2",
        },
      ],
      results:
        "Jami 9 ta medal: 3 oltin, 4 kumush, 2 bronza. O'zbekiston jamoasi umumiy hisobda 5-o'rinni egalladi.",
      description:
        "ISSF Jahon Kubogi Braziliyaning Rio de Janeiro shahrida muvaffaqiyatli o'tkazildi. O'zbekiston O'q otish jamoasi a'lo darajadagi natijalar ko'rsatdi.",
    },
    {
      id: 2,
      type: "international",
      year: 2024,
      name: "Osiyo O'q otish Chempionati",
      ...
      participantsList: [
        ...
        },
        {
          name: "Yulduz Tursunova",
          category: "Skeet",
          result: "Oltin medal - 46/50",
        },
        {
          name: "Dilnoza Karimova",
          category: "Pnevmatik",
          result: "Kumush medal - 248.3",
        },
      ],
      results:
        "Jami 12 ta medal: 5 oltin, 3 kumush, 4 bronza. O'zbekiston jamoasi 1-o'rinni egalladi.",
      description:
        "Uy meydoni - Toshkentda o'tgan Osiyo chempionatida O'zbekiston jamoasi ajoyib natijalar ko'rsatdi.",
    },
    {
      id: 3,
      type: "international",
      ...
      results:
        "Jami 10 ta medal qo'lga kiritildi. O'zbekiston jamoasi O'q otish bo'yicha 4-o'rinni egalladi.",
      description:
        "Xitoyning Hangzhou shahrida bo'lib o'tgan Osiyo O'yinlarida ishtirok etildi.",
    },
    {
      id: 4,
      type: "republican",
      ...
      participantsList: [
        {
          name: "Sardor Yusupov",
          category: "Pnevmatik vintovka",
          result: "Chempion - 632.1",
        },
        {
          name: "Nodira Rahimova",
          category: "Pnevmatik pistolet",
          result: "Chempion - 581.4",
        },
      ],
      results:
        "Respublika bo'ylab 180 ta sportchi ishtirok etdi. Yangi rekordlar o'rnatildi.",
    ...
    },
    {
      ...
      participantsList: [
        {
          name: "Aziz Tursunov (U21)",
          category: "Vintovka yotgan",
          result: "Oltin - 625.3",
        },
        {
          name: "Dilshod Aliyev (U19)",
          category: "Vintovka tik",
          result: "Oltin - 618.7",
        },
      ],
    ...
    },
    {
      ...
      participantsList: [
        {
          name: "Mudofaa vazirlig jamoasi",
          category: "Jamoaviy",
          result: "1-o'rin",
        },
        {
          name: "Ichki ishlar jamoasi",
          category: "Jamoaviy",
          result: "2-o'rin",
        },
      ],
      results:
        "Mudofaa vazirlig birlashmalariga qarashli jamoalar o'rtasida musobaqa.",
    ...
    // 2023 Competitions
    {
      ...
      participantsList: [
        ...
        },
        {
          name: "Doniyor Islamov",
          category: "50m Vintovka",
          result: "Kumush medal - 621.4",
        },
        {
          name: "Bekzod Rahimov",
          category: "Vintovka yotgan",
          result: "Bronza medal - 458.7",
        },
      ],
      results:
        "Jami 9 ta medal: 2 oltin, 3 kumush, 4 bronza. Osiyo mintaqasidan eng yaxshi natija.",
      description:
        "Ozarbayjonning Baku shahrida o'tgan ISSF Jahon Kubogida O'zbekiston sportchilari yaxshi ko'rsatkich ko'rsatdi.",
    },
    {
      id: 202,
      type: "international",
      ...
      participantsList: [
        {
          name: "Sevara Nematova",
          category: "10m Pnevmatik",
          result: "Oltin medal - 249.2",
        },
        {
          name: "Yulduz Tursunova",
          category: "Skeet",
          result: "Oltin medal - 45/50",
        },
        {
          name: "Dilnoza Karimova",
          category: "Pnevmatik",
          result: "Kumush medal - 246.5",
        },
      ],
      results:
        "Jami 9 ta medal: 4 oltin, 2 kumush, 3 bronza. Osiyo chempionlaridan biri.",
      description:
        "Malayziyada bo'lib o'tgan Osiyo chempionatida O'zbekiston jamoasi 2-o'rinni egalladi.",
    },
    {
      id: 203,
      type: "republican",
      ...
      participantsList: [
        {
          name: "Sardor Yusupov",
          category: "Pnevmatik vintovka",
          result: "Chempion - 629.3",
        },
        {
          name: "Nodira Rahimova",
          category: "Pnevmatik pistolet",
          result: "Chempion - 579.6",
        },
        { name: "Jasur Aliyev", category: "Trap", result: "Chempion - 46/50" },
      ],
      results:
        "Respublika bo'ylab 220 ta sportchi ishtirok etdi. Milliy jamoa tarkibi yangilandi.",
      description:
        "Milliy chempionat. 2024-yil xalqaro musobaqalariga tayyorgarlik.",
    },
    {
      id: 204,
      type: "republican",
      ...
      participantsList: [
        ...
        {
          name: "Shohruh Karimov (U19)",
          category: "Pnevmatik",
          result: "Oltin - 623.1",
        },
      ],
      results:
        "Yoshlar o'rtasida 21 ta medal taqsimlandi. Ko'plab talantlar aniqlandi.",
      description:
        "Yoshlar kubogi - kelajak chempionlar uchun boshlang'ich platforma.",
    },
    // 2022 Competitions
    {
      id: 301,
      ...
      participantsList: [
        {
          name: "Doniyor Islamov",
          category: "50m Vintovka",
          result: "Oltin medal - 625.8",
        },
        {
          name: "Mirjalol Khasanov",
          category: "Trap",
          result: "Kumush medal - 46/50",
        },
        {
          name: "Sevara Nematova",
          category: "Pnevmatik",
          result: "Bronza medal - 247.9",
        },
      ],
      results:
        "Jami 9 ta medal: 3 oltin, 4 kumush, 2 bronza. O'zbekiston 5-o'rinni egalladi.",
      description:
        "Xitoyning Guangzhou shahrida bo'lib o'tgan Osiyo O'yinlarida ishtirok etildi.",
    },
    {
      id: 302,
      type: "international",
      ...
      participantsList: [
        {
          name: "Yulduz Tursunova",
          category: "Skeet",
          result: "Oltin medal - 44/50",
        },
        {
          name: "Bekzod Rahimov",
          category: "Vintovka",
          result: "Kumush medal - 619.3",
        },
        {
          name: "Dilnoza Karimova",
          category: "Pnevmatik",
          result: "Bronza medal - 245.2",
        },
      ],
      results: "Jami 7 ta medal: 1 oltin, 3 kumush, 3 bronza.",
      description:
        "Misrning Kairo shahrida o'tkazilgan jahon chempionatida ishtirok etildi.",
    },
    {
      id: 303,
      type: "republican",
      ...
      participantsList: [
        {
          name: "Sardor Yusupov",
          category: "Pnevmatik",
          result: "Chempion - 626.7",
        },
        {
          name: "Nodira Rahimova",
          category: "Pistolet",
          result: "Chempion - 576.3",
        },
        { name: "Jasur Aliyev", category: "Trap", result: "Chempion - 45/50" },
      ],
      results:
        "Respublika bo'ylab 200 ta sportchi qatnashdi. Milliy jamoa shakllandi.",
  ...
  return (
    <div
      className={`min-h-screen pt-10 pb-30 px-4 sm:px-6 lg:px-8 relative overflow-hidden transition-colors duration-300 ${
        isDark
    ...
    >
        ...
        <div className="flex flex-col items-center gap-6 mb-16">
          ...
          <div className="flex gap-3 flex-wrap justify-center">
            {[
              {
                value: "all" as const,
                label: language === "uz" ? "Hammasi" : "Все",
                icon: Calendar,
              },
              {
                value: "international" as const,
                label: language === "uz" ? "Xalqaro" : "Международные",
                icon: Trophy,
              },
              {
                value: "republican" as const,
                label: language === "uz" ? "Respublika" : "Республиканские",
                icon: Medal,
              },
              ...
              <motion.button
                ...
                className="relative px-4 py-1 rounded-xl"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
              >
                {filterType === value && (
                ...
                <span
                  className={`relative z-10 flex items-center gap-2 text-[12px] ${
                ...
                >
                  ...
                  <motion.div
                    className={`absolute top-1/2 -translate-y-1/2 ${
                      isLeft ? "right-0 -mr-8" : "left-0 -ml-8"
                    } w-16 h-16 rounded-full bg-gradient-to-br from-amber-500 to-emerald-500 flex items-center justify-center shadow-2xl z-20`}
                    initial={{ scale: 0, rotate: -180 }}
                  ...
                  >
                    <div
                      className={`relative backdrop-blur-lg border-2 rounded-3xl overflow-hidden transition-all duration-300 ${
                        isDark
                    ...
                    >
                      {/* Glow Effect */}
                      <div
                        className={`absolute inset-0 bg-gradient-to-r from-amber-500/0 via-amber-500/20 to-amber-500/0 opacity-0 group-hover:opacity-100 transition-opacity ${
                      ...
                      <div className="relative h-48 overflow-hidden">
                        ...
                        <motion.div
                          ...
                          } w-12 h-12 rounded-full bg-slate-900/90 backdrop-blur-sm flex items-center justify-center shadow-lg border-2 border-amber-500/40`}
                          whileHover={{ rotate: 360, scale: 1.2 }}
                          transition={{ duration: 0.6 }}
                        >
                          {(() => {
                            const { icon: Icon, color } = getSportIcon(
                              comp.sport
                            );
                      ...
                      <div className="p-4 space-y-4">
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          >
                            ...
                            />
                            {comp.participants}{" "}
                            {language === "uz" ? "ishtirokchi" : "участников"}
                          </div>
                        </div>
                          ...
                          <div
                            className={`flex-1 text-center py-2 rounded-lg border ${
                              isDark
                                ...
                                : "bg-yellow-50 border-yellow-400/40"
                            }`}
                          >
                            <div
                              className={`text-lg ${
                          ...
                          <div
                            className={`flex-1 text-center py-2 rounded-lg border ${
                              isDark
                                ...
                                : "bg-gray-100 border-gray-400/40"
                            }`}
                          >
                            <div
                              className={`text-lg ${
                          ...
                          <div
                            className={`flex-1 text-center py-2 rounded-lg border ${
                              isDark
                                ...
                                : "bg-orange-50 border-orange-400/40"
                            }`}
                          >
                            <div
                              className={`text-lg ${
      ...
      >
        <DialogContent
          className={`min-w-[800px] max-w-[800px] max-h-[75vh] overflow-y-auto border-amber-500/40 text-white ${
            isDark
        ...
        >
          {selectedCompetition && (
            <>
              <DialogHeader>
                <DialogTitle className="text-2xl text-amber-300 flex items-center gap-3">
                  <Trophy className="w-6 h-6" />
                  {selectedCompetition.name}
                </DialogTitle>
                <DialogDescription className="text-emerald-400 text-sm">
              ...
              <Tabs defaultValue="participants">
                ...
                <TabsContent value="participants" className="mt-2">
                  <div className="space-y-3">
                    {selectedCompetition.participantsList.map(
                      (participant, index) => (
                        <motion.div
                          key={index}
                ...
                <TabsContent value="media" className="mt-2 space-y-6">
                  {/* Images */}
                  {selectedCompetition.images.length > 0 && (
                    <div>
                      ...
                      >
                        {language === "uz" ? "Rasmlar" : "Фотографии"}
                      </h4>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {selectedCompetition.images.map((image, index) => (
                          ...
                          >
                            <ImageWithFallback
                              src={image}
                              alt={`${selectedCompetition.name} ${index + 1}`}
                              className="w-full h-full object-cover"
                            />
                          </motion.div>
                        ))}
                  ...
                  {selectedCompetition.images.length === 0 &&
                    selectedCompetition.videos.length === 0 && (
                      ...
                      >
                        {language === "uz"
                          ? "Media hozircha mavjud emas"
                          : "Медиа пока недоступно"}
                      </div>
                    )}
                </TabsContent>
              </Tabs>
